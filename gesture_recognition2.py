...
"""
def print_result_landmark(result: mp.tasks.vision.HandLandmarkerResult, output_image: mp.Image, timestamp_ms: int):
...
class handDetector():
    def __init__(self,mode=False,maxHands=2,modelComplexity=1,detectionCon=0.5,trackCon = 0.5):
        ...
        landmark_options = vision.HandLandmarkerOptions(
...
with handDetector(maxHands=1) as hands:
    while cap.isOpened():
        ...
        image = hands.findHands(mp_image, timestamp)
